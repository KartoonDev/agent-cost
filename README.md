...
เปิด http://127.0.0.1:8791 แล้วทิ้งไว้ได้เลย ทำงานกับ agent เสร็จแต่ละรอบ ตัวเลขจะขึ้นเองภายในไม่กี่วินาที
เปิดได้แค่ในเครื่องตัวเอง (ข้อมูลไม่ออกนอกเครื่อง)
